...
function getOptionsForFormatting(eslintConfig) {
  ...
  eslint = (0, _extends3.default)({}, eslint, {
    rules: (0, _extends3.default)({}, eslint.rules, {
...
function getRelevantESLintConfig(eslintConfig, eslintPath) {
  ...
  var loadedRules = cliEngine.getRules && cliEngine.getRules() || new _map2.default([["valid-jsdoc", { meta: {} }], ["global-require", { meta: {} }], ["no-with", { meta: {} }]]);
